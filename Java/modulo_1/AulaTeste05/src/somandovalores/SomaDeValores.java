 ...
 */
package somandovalores;

/**
 *
 * @author Melquisedeque
 */
public class SomaDeValores extends javax.swing.JFrame {

    /**
     * Creates new form SomaDeValores
     */
    public SomaDeValores() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SomaDeValores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SomaDeValores().setVisible(true);
            }
        });
    }
